...
class AchaEstrela:
    ...
    def __init__(self):
        ...
        self.angulo_passo_azimute=0.069
        self.angulo_passo_altura= 0.069        
        self.tempo_passo=17
    ...
    def aciona_motor_horizontal_anti_horario(self,azimute):
        ...
        ap=self.angulo_passo_azimute #b é a quantidade de passos 1passo=0.111940298
        ...
        b=(round(azimute/ap)) ## Aqui foi trocada de int para round
        c=b+20  ## Variável para ajustar as engrenagens do motor
        ...
        if b!=0:
            ...
            #motor_horizontal.horario(10,25) ##Ajuste da engrenagem do motor
            #motor_horizontal.anti_horario(10,5) ##Ajuste da engrenagem do motor       
    ...
    def aciona_motor_horizontal_horario(self,azimute):
        ...
        if b!=0:
            ...
            #motor_horizontal.anti_horario(10,25)
            #motor_horizontal.horario(10,5)
    ...
    def aciona_motor_vertical_anti_horario(self,altura):
        ...
        if b!=0:
            ...
            ##motor_vertical.horario(10,25)
            ##motor_vertical.anti_horario(10,5)
    ...
    def aciona_motor_vertical_horario(self,altura):
        ...
        if b!=0:
            ...
            ##motor_vertical.anti_horario(10,25)
            ##motor_vertical.horario(10,5)
...
############################################################################ 
    ...
    def primeira_estrela(self):
        ...
        if azimute<180:
            ...
            if resultado==True:                
                ## A altura só vai girar de um lado, acima do horizonte 
                ##ou horário 
...
## Essa função corrige o altura para um segundo objeto a ser encontrado  
    ...
    def acompanha_estrela_azimute(self):
        ...
        azimute=self.angulo_passo_azimute         
        self.vetor_acompanha_azimute.append(self.azimute_decimal())
        ...
        if self.vetor_acompanha_azimute[0]>self.vetor_acompanha_azimute[-1]:
            ...
            if (self.vetor_acompanha_azimute[0]-self.vetor_acompanha_azimute[-1])<self.angulo_passo_azimute :
                sleep(0.1)           
            else:
            ...
            if (self.vetor_acompanha_azimute[-1]-self.vetor_acompanha_azimute[0])<self.angulo_passo_azimute:
                sleep(0.1)
            else:
...
## Essa função corrige a altura do objeto em tempo real     
    def acompanha_estrela_altura(self):
        ...
        sleep(1)  
        ## Aqui é necessário ser o mesmo angulo corrigido, já que o resultado deve ser o pulo de 1 passo      
        altura=self.angulo_passo_altura        
        self.vetor_acompanha_altura.append(self.altura_decimal())
        if self.vetor_acompanha_altura[0]>self.vetor_acompanha_altura[-1]:
            if (self.vetor_acompanha_altura[0]-self.vetor_acompanha_altura[-1])<self.angulo_passo_altura:
                sleep(1)            
            else:                
                self.aciona_motor_vertical_anti_horario(altura)
            ...
            if (self.vetor_acompanha_altura[-1]-self.vetor_acompanha_altura[0])<self.angulo_passo_altura:
                sleep(1)                
            else:
                self.aciona_motor_vertical_horario(altura)
                self.passos_corrigidos_altura+=1
