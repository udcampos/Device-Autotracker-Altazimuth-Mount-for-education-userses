...
from acha_estrela_v7 import AchaEstrela as acha
...
class LocalizaObjeto:
    ...
    def um_passo_para_baixo(self):        
        ...
        ###motor_vertical.anti_horario(100,passos)
        return True
    ...
    def um_passo_para_cima(self):
        passos=self.objeto.passos_minimos_acompanhamento
        ###motor_vertical=Motor(12,20,16,21)
        ###motor_vertical.horario(100,passos)
        return True
    ...
    def um_passo_para_direita(self):
        ...
        ###motor_horizontal.horario(100,passos)
        return True
    ...
    def um_passo_para_esquerda(self):
        passos=self.objeto.passos_minimos_acompanhamento
        ###motor_horizontal=Motor(13,25,19,26)        
        ###motor_horizontal.anti_horario(100,passos)
        return True
