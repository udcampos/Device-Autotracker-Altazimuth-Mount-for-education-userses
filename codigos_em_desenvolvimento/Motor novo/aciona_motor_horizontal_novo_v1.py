...
Nota1: A versão 2 implementa os ajustes das engrenagens, que leva o motor
20 passos adiante, volta 25, e vai adiante mais 5. Esse ajuste tem como
principal objetivo, melhorar a precisão da parada.

"""

from Motor_half_step import Motor
from Motor_drive_novo import Motor as motor_novo
...
class TestaMotor:
    ...
    def __init__(self, instancia_tk):
        ...
        self.espaço=tk.Message(self.fr3,
                               ...
                               pady=5,width=400)
        self.espaço.pack()
        self.mensagem2="Digite aqui o tempo em ms de cada passo (>=100) "
    ...
    def aciona_motor_horizontal_anti_horario(self): 
            a,b= self.valores()    
            if (a>=100) and (b!=0):                
                motor_horizontal= motor_novo("anti",25,b,a)
                motor_horizontal.automatiza_rotacao()
    ...
    def aciona_motor_horizontal_horario(self):
        a,b=self.valores()
        if (a>=100) and (b!=0):            
            motor_horizontal= motor_novo("horario",25,b,a)
            motor_horizontal.automatiza_rotacao()
