...
class EncontraNorte:
   ...
   ## Essa função corrige o nivel do telescópio, o algoritimo foi feito apos estudo matemático
    def corrige_nivel(self):
        ...
        if (diferenca>2) and (diferenca<3) and quadrado>0:
            print(diferenca,quadrado)
            return True

        elif (diferenca>3) and (diferenca<20) and quadrado>9:
            self.motor_vertical.anti_horario(20,3)
            self.corrige_nivel()

        elif diferenca>20 and diferenca<100 and quadrado>400:
            self.motor_vertical.anti_horario(20,30)
            self.corrige_nivel()
        ...
        ## Condições para corrigir o nível quando o telescopio esta abaixo do nivel
            ...
            self.motor_vertical.horario(20,50)
            self.corrige_nivel()
        return True
    ...
    def varias_leituras(self):
        ...
        while a<512:
            ...
            self.motor_horizontal.anti_horario(10,1)
            #print(a,",",b,",",c,",",d)
            #print(a,",",f,",",e)
            print(a)
            a+=1
   ...
   ## Função de ajuste da curva dos eixos yx e zx
    ...
    def aponta_norte(self):
        ...
        self.motor_horizontal.horario(20,330)
