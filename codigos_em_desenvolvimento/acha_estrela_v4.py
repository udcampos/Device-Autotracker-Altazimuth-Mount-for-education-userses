...
class AchaEstrela:
    ...
    def __init__(self):
        ...
        self.angulo_correcao_azimute=0.7
        self.angulo_correcao_altura=0.7
        self.tempo_passo=17
   ...
   ############################################################################ 
    ...
    def acompanha_estrela_azimute(self):
        ...
        if self.vetor_acompanha_azimute[0]>self.vetor_acompanha_azimute[-1]:
            ...
            if (self.vetor_acompanha_azimute[0]-self.vetor_acompanha_azimute[-1])<self.angulo_correcao_azimute :
                sleep(0.1)           
            else:
           ...
           if (self.vetor_acompanha_azimute[-1]-self.vetor_acompanha_azimute[0])<self.angulo_correcao_azimute:
                sleep(0.1)
           else:
    ...
    def acompanha_estrela_altura(self):
        ...
        if self.vetor_acompanha_altura[0]>self.vetor_acompanha_altura[-1]:
            if (self.vetor_acompanha_altura[0]-self.vetor_acompanha_altura[-1])<self.angulo_correcao_altura:
                sleep(1)            
            else:                
                self.aciona_motor_vertical_anti_horario(altura)
           ...
           if (self.vetor_acompanha_altura[-1]-self.vetor_acompanha_altura[0])<self.angulo_correcao_altura:
                sleep(1)                
           else:
                self.aciona_motor_vertical_horario(altura)
                self.passos_corrigidos_altura+=1
