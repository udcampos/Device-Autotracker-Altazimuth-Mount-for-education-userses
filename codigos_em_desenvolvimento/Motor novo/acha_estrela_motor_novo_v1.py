...
class AchaEstrela:
    ...
    def __init__(self):
        ...
        self.angulo_passo_azimute = 0.0171
        self.angulo_passo_altura = 0.0087890625
        self.tempo_passo = 160
        self.tempo_passo_motor_novo= 350
        self.passos_ajuste = 200
        self.passos_minimos_acompanhamento = 10
...
# # Essa função movimenta o motor do azimute sentido anti_horario
    ...
    def aciona_motor_horizontal_anti_horario_acompanhamento(self):
        ...
        if passos != 0:
            ...
            motor_horizontal_anti_horario=mv("anti", 25, passos, a)
            motor_horizontal_anti_horario.automatiza_rotacao()
    ...
    def define_azimute_proxima_estrela(self, azimute_acompanhamento):
        ...
        if e1 == e2:
            if vetor_azimute[-2] > vetor_azimute[-1]:
                ...
                ####### Acrescentado para corrigir correçao, pois deleta os valores anteriores, e inicia o acompnhamanto da coordenada atual 
